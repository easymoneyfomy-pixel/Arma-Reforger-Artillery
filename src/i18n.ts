      ...
      en: {
        translation: {
          ...
          map: {
            ...
            cep: "CEP",
            calibrate: "Calibrate",
            calibrating: "Calibrating {{step}}/3",
            north: "N",
            grid: "grid",
            calibWizard: "Calibration Wizard",
            calibStep1: "Click known point 1 (P1)",
            calibStep2: "Click known point 2 (P2)",
            calibStep3: "Click known point 3 (P3)",
            calibReview: "Review calibration. Drag points to fine-tune.",
            calibNext: "Next Step",
            calibFinish: "Finish & Save",
            calibCancel: "Cancel",
            calibBack: "Back",
            calibWorldPos: "Enter World Coordinates (m)",
      ...
      ru: {
        translation: {
          ...
          map: {
            ...
            calibrating: "Калибровка {{step}}/3",
            north: "С",
            grid: "сетка",
            calibWizard: "Мастер калибровки",
            calibStep1: "Укажите известную точку 1 (P1)",
            calibStep2: "Укажите известную точку 2 (P2)",
            calibStep3: "Укажите известную точку 3 (P3)",
            calibReview: "Проверьте калибровку. Точки можно перетаскивать.",
            calibNext: "Далее",
            calibFinish: "Завершить",
            calibCancel: "Отмена",
            calibBack: "Назад",
            calibWorldPos: "Введите мировые координаты (м)",
