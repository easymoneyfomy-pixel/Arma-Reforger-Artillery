        ...
        <div className="p-8 space-y-10">
          ...
          <div className="panel-alt bg-black/40 p-4 rounded-sm border-line/20 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://github.com/easymoneyfomy-pixel/Arma-Reforger-Artillery" target="_blank" rel="noopener noreferrer" className="text-[10px] font-mono text-zinc-500 hover:text-zinc-300 flex items-center gap-1.5">
